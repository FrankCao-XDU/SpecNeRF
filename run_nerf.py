...
from net_loss_define import fetch_net_loss_criternion
...
def train():
    ...
    args.expname = os.path.split(args.config)[-1]  
    ...
    if args.render_only:
        ...
        with torch.no_grad():
            ...
            exp_path = r'configs'
            params = Params(exp_path + os.sep + '_params.json')
    ...
    spectral_loss_weights = np.ones(args.spectrum_num) 
    if args.use_weighted_spectral_loss:
        spectral_loss_weights = [1., 3., 4., 3., 4., 4., 4., 2., 1., 1., 1.]  
